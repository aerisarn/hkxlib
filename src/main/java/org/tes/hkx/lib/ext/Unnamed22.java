...
public class Unnamed22 implements IHkContainer, IHkVisitable
{

    private Unnamed23 role;
    private String type;

    public Unnamed22() {
        setRole(null);
        setType("VARIABLE_TYPE_POINTER");
    }

    @XmlElement(name = "hkparam[@name=\"role\"]/hkobject")
    public Unnamed23 getRole() {
        return role;
    }

    public void setRole(Unnamed23 newRole) {
        this.role = newRole;
    }
