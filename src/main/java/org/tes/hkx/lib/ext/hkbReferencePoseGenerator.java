...
@XmlDiscriminatorValue("0x26a5675a")
@XmlType(propOrder = {
    "variableBindingSet",
    "userData",
    "name"
})
public class hkbReferencePoseGenerator
    ...
    implements IHkContainer, IHkVisitable
{
    ...
    public hkbReferencePoseGenerator() {
        setVariableBindingSet(null);
        setUserData("0");
        setName("CustomGenerator00");
        setClazz("hkbReferencePoseGenerator");
    }
