...
public class innerFootIkControlGains extends innerVisitable implements IHkVisitable, IHkInnerObject {
	...
	public innerFootIkControlGains() {
		setOnOffGain(null);
