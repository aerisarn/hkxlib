...
public class innerMotionInfo implements IHkContainer, IHkVisitable, IHkInnerObject {
	...
	private innerMotionStateInfo motionState;
	...
	public innerMotionStateInfo getMotionState() {
		return motionState;
	}

	public void setMotionState(innerMotionStateInfo newMotionState) {
