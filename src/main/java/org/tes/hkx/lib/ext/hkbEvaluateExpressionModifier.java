...
@XmlDiscriminatorValue("0xf900f6be")
@XmlType(propOrder = {
    "variableBindingSet",
    "userData",
    "name",
...
public class hkbEvaluateExpressionModifier
    ...
    implements IHkContainer, IHkVisitable
{
    ...
    public hkbEvaluateExpressionModifier() {
        setVariableBindingSet(null);
        setUserData("2");
        setName("HeadTracking_EEM");
        setEnable("true");
        setExpressions(null);
        setClazz("hkbEvaluateExpressionModifier");
    }
    ...
    @XmlIDREF
    @XmlPath("hkparam[@name=\"expressions\"]/text()")
    @ObjectLink
    public hkbExpressionDataArray getExpressions() {
        return expressions;
    }

    public void setExpressions(hkbExpressionDataArray newExpressions) {
    ...
    public<T >T accept(IHkParentVisitor<T> visitor, IHkVisitable parent) {
        ...
        if (!(null == getExpressions())) {
            getExpressions().accept(visitor, this);
        }
        return visitor.getResults();
    }
    ...
    public Collection<IHkVisitable> objects() {
        ...
        if (!(null == getExpressions())) {
            theseObjects.add(getExpressions());
        }
        return theseObjects;
    }
    ...
    public boolean remove(Object toRemove) {
        ...
        if ((getExpressions()!= null)&&getExpressions().equals(toRemove)) {
            setExpressions(null);
            return true;
        }
        return false;
