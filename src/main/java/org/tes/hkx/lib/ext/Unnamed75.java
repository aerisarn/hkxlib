...
public class Unnamed75 implements IHkContainer, IHkVisitable
{

    private String groundPosition;
    private Unnamed76 ungroundedEvent;
    ...
    public Unnamed76 getUngroundedEvent() {
        return ungroundedEvent;
    }

    public void setUngroundedEvent(Unnamed76 newUngroundedEvent) {
