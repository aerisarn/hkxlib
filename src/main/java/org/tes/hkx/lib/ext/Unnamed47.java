...
public class Unnamed47 implements IHkContainer, IHkVisitable
{

    private Unnamed48 triggerInterval;
    private Unnamed49 initiateInterval;
    ...
    public Unnamed48 getTriggerInterval() {
        return triggerInterval;
    }

    public void setTriggerInterval(Unnamed48 newTriggerInterval) {
        this.triggerInterval = newTriggerInterval;
    }

    @XmlElement(name = "hkparam[@name=\"initiateInterval\"]/hkobject")
    public Unnamed49 getInitiateInterval() {
        return initiateInterval;
    }

    public void setInitiateInterval(Unnamed49 newInitiateInterval) {
