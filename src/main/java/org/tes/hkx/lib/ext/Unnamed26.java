...
public class Unnamed26 implements IHkContainer, IHkVisitable
{

    private Unnamed27 role;
    private String type;

    public Unnamed26() {
        setRole(null);
        setType("VARIABLE_TYPE_BOOL");
    }

    @XmlElement(name = "hkparam[@name=\"role\"]/hkobject")
    public Unnamed27 getRole() {
        return role;
    }

    public void setRole(Unnamed27 newRole) {
        this.role = newRole;
    }
