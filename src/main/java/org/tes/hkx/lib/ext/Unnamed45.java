...
public class Unnamed45 implements IHkContainer, IHkVisitable
{

    private String originalAnkleTransformMS;
    private String kneeAxisLS;
    private String footEndLS;
    private Unnamed46 ungroundedEvent;
    ...
    public Unnamed45() {
        setOriginalAnkleTransformMS("(0.000000 0.000000 0.000000)(0.000000 0.000000 0.000000 1.000000)(1.000000 1.000000 1.000000)");
    ...
    public Unnamed46 getUngroundedEvent() {
        return ungroundedEvent;
    }

    public void setUngroundedEvent(Unnamed46 newUngroundedEvent) {
