...
@XmlDiscriminatorValue("0x8003d8ce")
@XmlType(propOrder = {
    "variableBindingSet",
    "userData",
    "name",
...
public class BSRagdollContactListenerModifier
    ...
    implements IHkContainer, IHkVisitable
{
    ...
    public BSRagdollContactListenerModifier() {
        ...
        setUserData("2");
        setName("CollisionListener");
        setEnable("true");
        setContactEvent(null);
        setBones(null);
        setClazz("BSRagdollContactListenerModifier");
    }
    ...
    public<T >T accept(IHkVisitor<T> visitor) {
        ...
        if (!(null == getContactEvent())) {
            getContactEvent().accept(visitor);
        }
        if (!(null == getBones())) {
    ...
    public<T >T accept(IHkParentVisitor<T> visitor, IHkVisitable parent) {
        ...
        if (!(null == getContactEvent())) {
            getContactEvent().accept(visitor, this);
        }
        if (!(null == getBones())) {
    ...
    public Collection<IHkVisitable> objects() {
        ...
        if (!(null == getContactEvent())) {
            theseObjects.add(getContactEvent());
        }
        if (!(null == getBones())) {
    ...
    public boolean remove(Object toRemove) {
        ...
        if ((getContactEvent()!= null)&&getContactEvent().equals(toRemove)) {
            setContactEvent(null);
            return true;
        }
