...
@XmlDiscriminatorValue("0xbda33bfe")
@XmlType(propOrder = {
    "variableBindingSet",
    "userData",
    "name",
...
public class BSGetTimeStepModifier
    ...
    implements IHkContainer, IHkVisitable
{
    ...
    public BSGetTimeStepModifier() {
        setVariableBindingSet(null);
        setUserData("2");
        setName("BSGetTimeStepModifier");
        setEnable("true");
        setTimeStep("0.000000");
        setClazz("BSGetTimeStepModifier");
    }
    ...
    @XmlPath("hkparam[@name=\"timeStep\"]/text()")
