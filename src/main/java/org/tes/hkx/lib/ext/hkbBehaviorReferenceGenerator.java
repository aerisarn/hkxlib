...
@XmlDiscriminatorValue("0xfcb5423")
@XmlType(propOrder = {
    "variableBindingSet",
    "userData",
    "name",
...
public class hkbBehaviorReferenceGenerator
    ...
    implements IHkContainer, IHkVisitable
{
    ...
    public hkbBehaviorReferenceGenerator() {
        ...
        setUserData("0");
        setName("SprintBFR");
        setBehaviorName("Behaviors\\SprintBehavior.hkx");
        setClazz("hkbBehaviorReferenceGenerator");
    }
    ...
    @XmlPath("hkparam[@name=\"behaviorName\"]/text()")
    ...
    public void setBehaviorName(String newBehaviorName) {
        this.behaviorName = newBehaviorName;
    }
