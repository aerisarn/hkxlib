...
public class Unnamed70 implements IHkContainer, IHkVisitable
{

    private String transform;
    private Unnamed71 sweptTransform;
    ...
    public Unnamed71 getSweptTransform() {
        return sweptTransform;
    }

    public void setSweptTransform(Unnamed71 newSweptTransform) {
