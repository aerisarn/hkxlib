...
public class innerListShapeInfo extends innerVisitable implements IHkContainer, IHkVisitable, IHkInnerObject {

	private hkpListShape childShape;

	public innerListShapeInfo() {
		setChildShape(null);
	}
	...
	@ObjectLink
	public hkpListShape getChildShape() {
		return childShape;
	}

	public void setChildShape(hkpListShape newChildShape) {
